...
use crate::core_executor::authentication::AllowanceType;
use crate::core_executor::contracts::solc::{
    AccountQuotaLimit, AllowanceManagement, EmergencyIntervention, NodeManager,
    PermissionManagement, PriceManagement, QuotaManager, Resource, SysConfig, UserManagement,
    VersionManager, AUTO_EXEC_QL_VALUE,
};
...
impl GlobalSysConfig {
    ...
    pub fn load(executor: &Executor, block_tag: BlockTag) -> Self {
        ...
        let allowance_management = AllowanceManagement::new(executor);
        conf.block_sys_config.account_allowances =
            allowance_management.load_account_allowances(block_tag);
        conf
    }
}
...
pub struct BlockSysConfig {
    ...
    pub account_allowances: HashMap<Address, AllowanceType>,
}
...
impl Default for BlockSysConfig {
    fn default() -> Self {
        BlockSysConfig {
            ...
            chain_version: 0,
            account_allowances: HashMap::new(),
        }
    }
}
