...
use cita_cloud_proto::blockchain::{CompactBlock as CloudCompactBlock, UnverifiedTransaction as CloudUnverifiedTransaction};
...
impl OpenBlock {
    ...
    pub fn insert_cloud_tx(&mut self, t: CloudUnverifiedTransaction) {
        let tx = SignedTransaction::from(t);
